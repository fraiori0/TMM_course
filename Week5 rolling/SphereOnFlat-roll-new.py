...
dpsi_t = dpsi.subs([(omegax,omegax_t),(omegay,omegay_t),(omegaz,omegaz_t)])
...
for count in range(numsteps):
    du1_new = du1_t.subs([(u1,u1_t),(v1,v1_t),(u2,u2_t),(v2,v2_t),(psi,psi_t)])
    du2_new = du2_t.subs([(u1,u1_t),(v1,v1_t),(u2,u2_t),(v2,v2_t),(psi,psi_t)])
    dpsi_new = dpsi_t.subs([(u1,u1_t),(v1,v1_t),(u2,u2_t),(v2,v2_t),(psi,psi_t)])
