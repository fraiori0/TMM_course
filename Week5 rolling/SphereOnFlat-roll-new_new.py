...
14Nov2021 Fixed typo in Tmat1 caught by Anderson Nardin
"""
...
"""
What happens if obj1 is a sphere, obj2 is flat?
"""
# KTM for unit sphere: R=1, [K] = [I], Torsion, Metric as in
# Montana eq. (15). See MontanaKmat.py for derivation
Kmat1 = eye(2)
# Tmat1 = Matrix([0, tan(u2)]).transpose()    #Thanks to Anderson
Tmat1 = Matrix([0, -tan(u1)]).transpose()
Mmat1 = diag(1, cos(u1))
